 ...
 * here.
 */
require('./leap-1.0.0.js')
require('./leap-plugins-0.1.12.js')
require('./leap-widgets-0.1.0.js')

leap = function (scene, camera){

  const DEFAULT_BONE_COLOR= 0xffffff
  const DEFAULT_JOINT_COLOR= 0xFFBD33
  const DEFAULT_BONE_SCALE = 1/12
  const DEFAULT_JOINT_SCALE = 1/8
  ...
  Leap.loopController.use('boneHand', {
    ...
    jointColor: (new THREE.Color).setHex(DEFAULT_JOINT_COLOR),
